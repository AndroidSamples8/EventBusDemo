...
public class BottomRightFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bottom_right, container, false);
    ...
    public void onEvent(SettingsEvent settingsEvent) {
        statusTextView.setText(" Bottom Right Status : " + settingsEvent.isBottomRightStatus());
    }
